...
--			set @FileRootName = 'IPC_Contact_Addresses'
		...
		BEGIN
			...
			-- select * from dbo.deletethis_managerconsensus_imported
			set @sql = '
			...
			SET @sql = ' ' +
			' INSERT INTO managerconsensus_imported ( 
				client_subgroup, prt_Relationship_Title, correspondence_firm_description, RRDescription, RowNumber, ManagerStrategy, PortfolioCode, Manager, Strategy, position_id, SecurityEffectiveDate, SecurityID, Ticker, IssuerName, SecurityTypeDescription, PortfolioTotalCashMarketValue, PortfolioTotalEquityMarketValue, PortfolioTotalMarketValue, PortfolioSecurityQuantity, SecurityPrice, PortfolioSecurityMarketValue, SecurityPercent_of_PortfolioMarketValue, SecurityPercent_of_PortfolioSecurityMarketValue, SecurityPercent_of_PortfolioEquityMarketValue, CountManagerStrategyPerTicker, ManagerStrategyTotalMarketValue, ManagerStrategySecurityMarketValue, SecurityPercent_of_ManagerStrategyMarketValue, ManagerStrategyTickerCountOfPortfolios, ManagerStrategyCountOfPortfolios, ManagerStrategySecurityModelTargetPercent, SecurityPercentOfManagerStrategyTotalMarketValue, countofrecords, AsOfDate, LotDate, HoldYears, Gain_Base, ShortTerm, LongTerm, PortfolioName
