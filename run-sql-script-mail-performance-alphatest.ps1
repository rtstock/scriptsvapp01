...
$DBParams = $DBParam1, $DBParam2, $DBParam3
invoke-sqlcmd -inputfile "$ScriptPath\send-email-results-performance-strategies-top-and-bottom-10-alphatest.sql" -Variable $DBParams -serverinstance "ipc-vsql01" -database "DataAgg" # the parameter -database can be omitted based on what your sql script does.
