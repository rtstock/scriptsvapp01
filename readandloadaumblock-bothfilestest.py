            ...
            for nodeA in soup.find_all('tr', attrs={}):
                ...
                for nodeB in nodeA.find_all('td', attrs={}):
                    ...
                    if nodeB.attrs['class'][0] in ['DataCellNumeric','DataCellString']:
                        #print 'got here!!!'
                        if fieldnames[len(fieldvalues)] == 'PortfolioRoot':
                            #print 'got here!!!!'
                            is_dataline = 1
                            PortfolioRoot = nodeB.string
                            print PortfolioRoot
...
if __name__=='__main__':
    ...
    myDataFilePathName = r"//Ipc-vsql01/data/Batches/prod/WatchFolder/incoming/PagesOutput_AUMOriginalCodeBlock_20170117 164234..xls"
