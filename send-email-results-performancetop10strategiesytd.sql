...
exec DataAgg..analysisofbenchmarks_performancemedianstatistics 'MTD',null,1
----------------------------------------------------------------------------------------------
select *
...
exec DataAgg..analysisofbenchmarks_performancemedianstatistics 'MTD'
...
--select count(*) from #_201612061430_subtype02
-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
OPEN @getAccountID
FETCH NEXT
FROM @getAccountID INTO @PerformanceName,@AccountSubType,@CountOfPortfolios,@AsOfDate,@TotalMarketValue,@Period,@MEDIAN_ROR,@Last_Update
...
BEGIN
 ...
 --print @i
 if @i = 1
	set  @BodyText = @BodyText + 'Top 10 IPC Strategies By Median Performance '+@Period+'
	As Of ' + @AsOfDate + '
	'
 ...
 ' + CONVERT(VARCHAR,@i)+')' + CHAR(9)+CONVERT(VARCHAR,ROUND(CONVERT(NUMERIC(6,3),@MEDIAN_ROR),3)) + '%' + 
 CHAR(9)+CHAR(9)+ DataAgg.dbo.PadRight(left(@PerformanceName,50),' ',50) +
 CHAR(9)+CHAR(9)+ @TotalMarketValueString 
...
All strategy and account performance data is attached.
	 
Source: IPC''s Global Wealth Platform & Sylvan Performance
	 '

EXEC sp_send_dbmail @profile_name='IPC Mail Profile',
@recipients='justin.malinchak@ipcanswers.com;justin.malinchak@gmail.com',
@subject='Top IPC Strategies By Median Performance',
@body=@BodyText,
@file_attachments=@myfile_attachments
