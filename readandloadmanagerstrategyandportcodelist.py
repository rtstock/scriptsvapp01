...
class perform:
    ...
    def __init__(self,p_datafilepathname):
        print 'initialized readandloadmanagerstrategyandportcodelist.py'
        self.DataFilePathName = p_datafilepathname
        
        self.ReadAndLoad()
        print 'exiting readandloadmanagerstrategyandportcodelist.py'
            ...
            for nodeA in soup.find_all('tr', attrs={}):
                ...
                if is_dataline == 1:
                    ...
                    if already_ran_delete_statement == 0:
                        cursor.execute("delete from dbo.xanalysisofbenchmarks_managerstrategyandportcodelist where AsOfDate = ?", fieldvalues['AsOfDate'] )
                        total_deleted = total_deleted + cursor.rowcount
                        print '  ',cursor.rowcount, 'records deleted'
                        cnxn.commit()
                        already_ran_delete_statement = 1
                    insert_sql = "insert into xanalysisofbenchmarks_managerstrategyandportcodelist("+fieldnames_string+") values ("+fieldvalues_string+")"
                    #print insert_sql
...
if __name__=='__main__':
    ...
    myDataFilePathName = r"//Ipc-vsql01/data/Batches/prod/WatchFolder/incoming/PagesOutput_GetManagerStrategyAndPortcodeList_2017-03-02 133902510.xls"
