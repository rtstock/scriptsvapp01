...
$PathFile = "\\ipc-vsql01\DATA\Batches\prod\WatchFolder\incoming\PagesOutput_GetPadPortBenchAsOf_20161124_ADAROT.xlsx"
$PathFile1 = "\\ipc-vsql01\DATA\Batches\prod\WatchFolder\incoming\PagesOutput_GetPadPortBenchAsOf_20161124_ADAROT-1.xlsx"
Copy-Item $PathFile $PathFile1
Write-host "pausing 5..."
Start-Sleep -s 5
Write-host "resuming..."
...
#$OleDbConn.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=""\\ipc-vsql01\DATA\Batches\prod\WatchFolder\incoming\PagesOutput_GetPadPortBenchAsOf_20161124_ADAROT-1.xls"";"
#$OleDbConn.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=""\\ipc-vsql01\DATA\Batches\prod\WatchFolder\incoming\PagesOutput_GetPadPortBenchAsOf_20161124_ADAROT-1.xls"";Extended Properties=\""Excel 12.0;HDR=YES;IMEX=1;MAXSCANROWS=15;READONLY=FALSE\"""
#$OleDbConn.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=""\\ipc-vsql01\DATA\Batches\prod\WatchFolder\incoming\PagesOutput_GetPadPortBenchAsOf_20161124_ADAROT-1.xls"";Extended Properties=\""Excel 12.0;HDR=YES;IMEX=1;MAXSCANROWS=15;READONLY=FALSE\"";"
$myConnectstring = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=""\\ipc-vsql01\DATA\Batches\prod\WatchFolder\incoming\PagesOutput_GetPadPortBenchAsOf_20161124_ADAROT-1.xlsx"";Extended Properties=""Excel 12.0 Xml;HDR=YES;IMEX=1"";"
#Write-host $myConnectstring 
$OleDbConn.ConnectionString = $myConnectstring
...
#$OleDbCmd.commandtext = "Select * from [PagesOutput_GetPadPortBenchAsOf]"
...
$OleDbConn.Close()
Remove-Item -Path $PathFile1 -Force
