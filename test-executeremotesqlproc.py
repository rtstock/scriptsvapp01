class procedure:
    ...
    def execute(self,server,database,procname,params):
        ...
        import urllib
        import sqlalchemy
        connection_string = 'DRIVER={SQL Server};SERVER=' + server + ';DATABASE=' + database + ';Trusted=Yes'
    ...
    def getfilesfromftp(self, fileroot, localfolder):
        ...
        for remotefilename in trav:
            fileroot = remotefilename[:10]
            if fileroot == 'procoutput':
...
if __name__ == "__main__":
    ...
    server='ipc-vsql01'
    database='DataAgg' #default
    procname='analysisofbenchmarks_performancemediantop10ytd' #default
    ...
    o = procedure()
    result = o.execute(server,database,procname,params)
    print result
    ...
    #try:
    #    print 'attempting to write to changethis.txt'
